...
<body>
		...
		<div class="widget-box" id="widget-box">
            ...
            时间:
						...
						<button class="btn btn-info" id="btn-search"
							authority="${pageContext.request.contextPath}/dwmReport/findDwmReportList.do">
							<i
					...
					<div id="toolbar" class="toolbar">
						...
						<button class="btn btn-info" id="btn-view-add"
							authority="${pageContext.request.contextPath}/dwmReport/insertDwmReport.do">
							<i
								class="ace-icon fa fa-plus-square  align-top bigger-125 icon-on-right"></i>
						</button>
						<button class="btn btn-info" id="btn-view-edit"
							authority="${pageContext.request.contextPath}/dwmReport/updateDwmReport.do">
							<i
						...
						<button class="btn btn-warning" id="btn-view-del"
							authority="${pageContext.request.contextPath}/dwmReport/deleteDwmReportByDwmReportId.do">
							<i
	...
	<script
		src="${pageContext.request.contextPath}/content/js/service/dwmReport/config.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/dwmReport/model.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/dwmReport/controller.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/dwmReport/view.js"></script>
