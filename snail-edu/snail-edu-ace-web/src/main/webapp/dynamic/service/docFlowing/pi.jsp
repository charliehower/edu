...
<%
	...
	request.setAttribute("id", docFlowTaskMapper.selectByPrimaryKey(id).getDocFlowId());
	...
	<div class="page-content">
		<div align="center">
			...
			<table class="altrowstable" id="alternatecolor" style="width: 100%">
				...
				<tr>
					<td colspan="6"> 转办结果：<input type="radio" name="status" value="1" checked="checked">转办  <input type="radio" name="status" value="2">已处理，结束任务 </td>
				</tr>
				<tr>
					<td colspan="6"> 转办对象：
		...
		<input type="hidden" name="pid" value="${param.id}">
			...
			<div>
				<button class="btn btn-info" id="btn-docFlow-submit"
					authority="false">
					<i class="ace-icon fa fa-check bigger-110"></i> 保存流转
				</button>
			</div>
