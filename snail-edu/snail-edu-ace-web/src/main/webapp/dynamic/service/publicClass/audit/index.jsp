...
<body>
		...
		<div class="widget-box" id="widget-box">
            ...
            ">
						状态：<input class="easyui-combobox"
							...
							name="status"
							data-options="
                    url:'${sessionScope.portalContextPath}/dict/findListByCategoryId.do?categoryId=41&defaultValue=01',
                    method:'get',
                    valueField:'code',
                    textField:'name',
                    panelHeight:'auto'
            ">
					...
					<div id="toolbar" class="toolbar">
						...
						<button class="btn btn-info" id="btn-view-audit"
							authority="${pageContext.request.contextPath}/publicClass/updateAudit.do">
							<i
	...
	<script
		src="${pageContext.request.contextPath}/content/js/service/publicClass/audit/config.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/publicClass/audit/model.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/publicClass/audit/controller.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/publicClass/audit/view.js"></script>
		...
		<div class="profile-info-row">
			<div class="radio">
				<label> <input name="status" type="radio" class="ace"
					checked="true" value="02" /> <span class="lbl">通过</span>
				</label> <label> <input name="status" type="radio" class="ace"
					value="09" /> <span class="lbl">退回</span>
				</label>
			</div>
		</div>
