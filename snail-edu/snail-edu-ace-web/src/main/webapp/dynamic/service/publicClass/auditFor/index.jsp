...
<body>
            ...
            ">
					...
					<div id="toolbar" class="toolbar">
						...
						<button class="btn btn-info" id="btn-view-audit"
							authority="${pageContext.request.contextPath}/publicClass/updateAuditFor.do">
							<i
	...
	<script
		src="${pageContext.request.contextPath}/content/js/service/publicClass/auditFor/config.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/publicClass/auditFor/model.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/publicClass/auditFor/controller.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/publicClass/auditFor/view.js"></script>
