...
<body>
            ...
            ">
					...
					<div id="toolbar" class="toolbar">
						...
						<button class="btn btn-info" id="btn-view-audit"
							authority="${pageContext.request.contextPath}/publicClass/updateAuditThi.do">
							<i
	...
	<script
		src="${pageContext.request.contextPath}/content/js/service/publicClass/auditThi/config.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/publicClass/auditThi/model.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/publicClass/auditThi/controller.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/publicClass/auditThi/view.js"></script>
