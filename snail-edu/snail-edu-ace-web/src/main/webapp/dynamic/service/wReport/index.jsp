...
<body>
	...
	<script
		src="${pageContext.request.contextPath}/content/js/service/wReport/config.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/wReport/model.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/wReport/controller.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/wReport/view.js"></script>
