	...
	<div class="page-content">
		...
		学期：<input class="easyui-combobox"
            ...
            标题：<input class="easyui-validatebox textbox"
							style="width: 500px; height: 25px; line-height: 25px;"
							name="title" 
							...
							name="departmentId"
							data-options="
                    url:'${pageContext.request.contextPath}/dwmReport/selectMyDeptUser.do',
                    method:'get',
                    valueField:'code',
                    textField:'name',
                    panelHeight:'auto'
...
<script
		...
		<script
		src="${pageContext.request.contextPath}/content/js/service/wReport/upload.js"></script>
