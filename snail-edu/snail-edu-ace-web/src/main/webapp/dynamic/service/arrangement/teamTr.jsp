...
<script type="text/javascript">
	var dataTeamTr = {};
	<c:forEach var="item" items="${listTeamTr}" varStatus="status">
	dataTeamTr['ttl${item.discipline_id}'] = '${item.name}';
	</c:forEach>
</script>
<div class="widget-box" id="widget-box">
			...
			<div class="widget-body">
				<div class="widget-main padding-6">
					<form action="index.jsp" id="fm-search-teamTr">
					<input type="hidden" name="active" value="ttl">
            ...
            ">
						...
						<button class="btn btn-info" id="btn-search-teamTr"
							authority="false">
							教研组长查询<i
...
<table style="width: 100%" id="grid-arr"
	...
	<thead>
		<tr>
			...
			<th align="left" width="200px">教研组长</th>
				...
				<td align="center">${item.discipline_name}</td>
					...
					<td align="center">
						<button authority="false"
							id="ttl${item.discipline_id}"
							onclick="saveOrUpdateTeamTr('${item.discipline_id}',dataTeamTr['ttl${item.discipline_id}'],'ttl${item.discipline_id}')"
							type="button" class="btn btn-info">
							<script>
								document
										.write(dataTeamTr['ttl${item.discipline_id}']
												|| '设置');
								if (!dataTeamTr['ttl${item.discipline_id}']) {
									$('#ttl${item.discipline_id}')
...
<div id="dialog-message-teamTr" class="hide">
	<form id="fm-teacher-search-teamTr">
		...
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
					...
					<input name="search-departmentId-teamTr" class="easyui-combotree" data-options="url:'${sessionScope.portalContextPath}/system/selectDepartmentTreeList.do?id=01',method:'get',animate: true,
		...
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				<input class="easyui-combobox" 
					style="width: 200px; height: 25px; line-height: 25px;"
					name="search-disciplineId-teamTr"
					data-options="
		...
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				<select class="easyui-combogrid" id="cc-teacher-teamTr" 
					style="width: 400px; height: 25px; line-height: 25px;" name="cc-teacher-teamTr"
