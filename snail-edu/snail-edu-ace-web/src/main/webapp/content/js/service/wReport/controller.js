jQuery(function($) {
	...
	$('#btn-view-add').on(
			'click',
			function() {
				parent.addPanel('编辑',contextPath+'/dynamic/service/wReport/add.jsp?id='+urlid,true);
			});
	$('#btn-view-edit').on(
			'click',
			function() {
				...
				parent.addPanel('编辑',contextPath+'/dynamic/service/wReport/add.jsp?id='+urlid+'&dwmReportId='+gd.dwmReportId,true);
			});
...
function dwmView(dwmReportId,title){
	parent.addPanel(title,contextPath+'/dynamic/service/wReport/preview.jsp?id='+urlid+"&dwmReportId="+dwmReportId,true);
}
function reloadGrid(){
