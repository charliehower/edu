jQuery(function($) {
	...
	var uploader = new plupload.Uploader({
		...
		url : portalContextPath+'/attach/uploadFile.do?noticeId='+dwmReportId+'&collectionName=dwmReport',
