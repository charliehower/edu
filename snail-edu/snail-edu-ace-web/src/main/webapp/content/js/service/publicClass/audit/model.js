	...
	,
		{
...

			{
				...
				renderer : function(value,cur) {
					var first=rsd(value, "STATIC_DATA_41");
					var sec="|"+$.jgrid.getAccessor(cur, 'auditSecStatus');
					var thi="|"+$.jgrid.getAccessor(cur, 'auditThiStatus');
					var fors="|"+$.jgrid.getAccessor(cur, 'auditForStatus');
					return first+sec+thi+fors;
				}
			}, {
				name : 'createTime',
				width : 200,
