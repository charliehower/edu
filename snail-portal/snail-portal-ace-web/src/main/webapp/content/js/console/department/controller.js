jQuery(function($) {
	...
	$( "#btn-view-da" ).on('click', function(e) {
		...
		var dialog = $( "#dialog-message" ).removeClass('hide').dialog({
			modal: true,
			width:610,
			title: "<div class='widget-header widget-header-small'><h4 class='smaller'><i class='ace-icon fa fa-cog'></i>部门人员</h4></div>",
			title_html: true,
			buttons: [ 
...
function batchUpdateUserAndTeacherByUserIds(departmentId){
	var users=new Array();
	...
	$.ajax({
		type : "post",
		url : contextPath + "/department/batchUpdateUserAndTeacherByUserIds.do",
		data:{jsons:jsons},
