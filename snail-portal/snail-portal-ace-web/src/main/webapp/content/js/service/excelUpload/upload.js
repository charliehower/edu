...
function init_uploader(){
	 $("#uploader").pluploadQueue({
	        ...
	        chunk_size : '1mb',
	        unique_names : true,
	        multipart_params:{jsons:JSON.stringify({excelId:excelId})}, 
	        filters : {
	            max_file_size : '10mb',
	            mime_types: [
	                 {title : "Zip files", extensions : "xls,xlsx"}
	            ]
	        },
	        ...
	        url : portalContextPath+'/excelMain/importXls.do',
