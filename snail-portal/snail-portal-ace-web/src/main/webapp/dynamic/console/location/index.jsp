	...
	<div class="widget-box" id="widget-box">
			...
			<div class="widget-body">
				<div class="widget-main padding-6">
					...
					上级位置： 
							<input id="cc1" name="parentId" class="easyui-combotree" data-options="url:'${pageContext.request.contextPath}/location/selectLocationTreeList.do?pid=0&load=all',method:'get',animate: true,
                lines:false," style='width:200px;line-height: 30px;height: 30px;'>
							<a href="javascript:clearQparams()">清除</a>
						位置名称： <input name="name" type="text" maxlength="20"
							style="width: 200px;"/>
								<button class="btn btn-info" id="btn-search"
							authority="${pageContext.request.contextPath}/location/findLocationList.do">
							<i
					...
					<div id="toolbar" class="toolbar">
						...
						<button class="btn btn-info" id="btn-view-add"
							authority="${pageContext.request.contextPath}/location/insertLocation.do">
							<i
								class="ace-icon fa fa-plus-square  align-top bigger-125 icon-on-right"></i>
						</button>
						<button class="btn btn-info" id="btn-view-edit"
							authority="${pageContext.request.contextPath}/location/updateLocation.do">
							<i
								class="ace-icon fa fa-edit  align-top bigger-125 icon-on-right"></i>
						</button>
						<button class="btn btn-warning" id="btn-view-del"
							authority="${pageContext.request.contextPath}/location/deleteLocationByLocationId.do">
							<i
	...
	<div class="easyui-layout" id="cc" style="width:100%;height:300px;">
		...
		<div id="cc-west" class="easyui-west" data-options="region:'west',split:true" title="我的树" style="width:200px;">
		 <ul id="tt" class="easyui-tree" data-options="
               url: '${pageContext.request.contextPath}/location/selectLocationTreeList.do?pid=0&load=all',
                method: 'get',
                animate: true,
                lines:false,
...
<div id="mm" class="easyui-menu" style="width:120px;">
	...
	<script
		src="${pageContext.request.contextPath}/content/js/console/location/config.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/console/location/model.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/console/location/controller.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/console/location/view.js"></script>
