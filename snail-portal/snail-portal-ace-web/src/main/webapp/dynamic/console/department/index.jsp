...
<body>
                ...
                lines:false,"
					...
					<div id="toolbar" class="toolbar">
						...
						<button class="btn btn-purple" id="btn-view-da"
							authority="${pageContext.request.contextPath}/department/batchUpdateUserAndTeacherByUserIds.do">
							 <i
		...
		<div class="easyui-layout" id="cc" style="width: 100%; height: 300px;">
			...
			<div id="cc-west" class="easyui-west"
				...
				<ul id="tt" class="easyui-tree"
					data-options="
               url: '${pageContext.request.contextPath}/system/selectDepartmentTreeList.do?id=01',
                method: 'get',
                animate: true,
                lines:false,
	...
	<script type="text/javascript">
		...
		function autoResize() {
			...
			$('#cc').css("height", h);
			$(cfg.grid_selector).jqGrid('setGridHeight', h - 60);
