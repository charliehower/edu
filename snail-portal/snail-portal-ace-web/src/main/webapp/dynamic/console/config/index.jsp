...
<body>
	...
	<script
		src="${pageContext.request.contextPath}/content/js/console/config/config.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/console/config/model.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/console/config/controller.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/console/config/view.js"></script>
