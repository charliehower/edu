...
<script
	src= "${sessionScope.portalContextPath}/content/assets/js/gz/jquery.jqGrid.js"></script>
<script
	src= "${sessionScope.portalContextPath}/content/assets/js/jqGrid/i18n/grid.locale-cn.js"></script>
<script
