...
<body>
		...
		<div class="widget-box" id="widget-box">
			...
			<div class="widget-body">
				<div class="widget-main padding-6">
					...
					编号： <input name="reportId" type="text" style="width: 100px;" />
						名称： <input name="reportName" type="text" style="width: 200px;" />
						
						<button class="btn btn-info" id="btn-search"
							authority="${pageContext.request.contextPath}/report/findReportList.do">
							<i
					...
					<div id="toolbar" class="toolbar">
						...
						<button class="btn btn-info" id="btn-view-add"
							authority="${pageContext.request.contextPath}/report/saveReportAndDetail.do">
							<i
								class="ace-icon fa fa-plus-square  align-top bigger-125 icon-on-right"></i>
						</button>
						<button class="btn btn-info" id="btn-view-edit"
							authority="${pageContext.request.contextPath}/report/updateReportAndDetail.do">
							<i
								class="ace-icon fa fa-edit  align-top bigger-125 icon-on-right"></i>
						</button>
						
						<button class="btn btn-warning" id="btn-view-del"
							authority="${pageContext.request.contextPath}/report/deleteReportById.do">
							<i
				...
				<tr>
					...
					<td align="center" valign="middle">
						<button class="btn btn-info" id="btn-view-da-add"
							authority="${pageContext.request.contextPath}/report/insertUsersRole.do">  
							分配<i
	...
	<script
		src="${pageContext.request.contextPath}/content/js/service/report/config.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/report/model.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/report/controller.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/service/report/view.js"></script>
