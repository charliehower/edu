...
<body>
	<div class="page-content">
		...
		<div class="widget-box" id="widget-box">
			<div class="widget-header">
				<h5 class="widget-title smaller">返聘申请</h5>
			...
			<div class="widget-body">
				<div class="widget-main padding-6">
					<form id="fm-workflow">
						...
						<div class="profile-info-row">
							<div class="profile-info-name">返聘时间</div>

							<div class="profile-info-value">
								<input class="easyui-datebox"
									style="width: 200px; height: 25px; line-height: 25px;"
									name="rehireTime" data-options="required:false">
							</div>
						</div>
				...
				<div class="profile-info-row">
							<div class="profile-info-name">返聘原因</div>

							<div class="profile-info-value">
								<input class="easyui-validatebox textbox"
									style="width: 600px; height: 150px" name="reasion"
	...
	<script type="text/javascript">
		...
		function isExitByTeacherId() {
			$.ajax({
				type : "post",
				url : "/edu/rehire/isExitByTeacherId.do",
				data : {
