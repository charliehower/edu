		...
		<div class="widget-box" id="widget-box">
			...
			<div class="widget-body">
				<div class="widget-main padding-6">
					<form id="fm-workflow">
					<input name="acceptUserId" type="hidden" value="${SystemUser.users.userId}">
					<input name="repairsUserId" type="hidden" value="${SystemUser.users.userId}">
					<input name="acceptTime" type="hidden" value="${now}">
					<input name="responseTime" type="hidden" value="${now}">
					<input name="stauts" type="hidden" value="2">
						...
						<div class="profile-info-row">
							<div class="profile-info-name">受理结果</div>
...
<div class="profile-info-row">
							<div class="profile-info-name">故障类型</div>
							...
							<div class="profile-info-value">
								...
								<input class="easyui-combobox"
									...
									name="faultCategory"
									data-options="
                    url:'${sessionScope.portalContextPath}/dict/findListByCategoryId.do?categoryId=27',
                    method:'get',
                    valueField:'code',
                    textField:'name',
                    panelHeight:'auto'
            ">
						...
						<div class="profile-info-row">
							<div class="profile-info-name">故障情况</div>

							<div class="profile-info-value">
								<input class="easyui-validatebox textbox"
									style="width: 600px; height: 150px" name="faultDescribtion"
