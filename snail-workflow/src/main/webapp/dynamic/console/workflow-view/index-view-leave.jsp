...
<%@page import="org.platform.snail.service.*"%>
...
<%
	...
	SystemUser t=systemService.getSystemUser(vo.getLeaveUserId(), cfg);
	...
	<div class="page-content">
		...
		<table style="width: 100%"
			...
			<tr>
				...
				<td colspan="6" align="center">${t.other.discriblineClassName}</td>
			...
			<tr>
				...
				<td colspan="2">${t.other.headmasterClassName}</td>
				<th colspan="2">所属其他管理部门</th>
				<td colspan="2">${t.dpFullName}</td>
			</tr>
			<tr>
