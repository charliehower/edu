				...
				<div class="widget-main padding-6">
					<form action="#" id="fm-search" class="hide">
						...
						<button class="btn btn-info" id="btn-search"
							authority="${pageContext.request.contextPath}/workflow/findWorkflowList.do">
							<i
					...
					<div id="toolbar" class="toolbar">
						...
						<button class="btn btn-info" id="btn-view-add"
							authority="${pageContext.request.contextPath}/workflow/deploy.do">
							<i
						...
						<button class="btn btn-warning" id="btn-view-del"
							authority="${pageContext.request.contextPath}/workflow/deleteWorkflowlById.do">
							<i
...
<div id="dialog-message" class="hide">
	...
	<script
		src="${pageContext.request.contextPath}/content/js/console/workflow/config.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/console/workflow/model.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/console/workflow/controller.js"></script>
	<script
		src="${pageContext.request.contextPath}/content/js/console/workflow/view.js"></script>
